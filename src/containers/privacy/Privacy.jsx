      ...
      <div className="bg-white text-[#00229B] body-font overflow-hidden">
        <div className="container px-5 py-12 mx-auto">
          <div className="flex flex-col text-center w-full mb-2">
            ...
            <h1 className="text-5xl title-font mb-2 mt-10 font-bold text-[#00229B]">
              Privacy Policy
            </h1>
          </div>
          <div className="flex flex-col w-full justify-center ">
            ...
            <p className="lg:w-2/3 mx-auto  leading-relaxed text-base text-left text-[#333333] pt-5">
              ...
              functions like allowing our metered paywall to work and key
              features like personalizing what posts you see based on what we
              think you’ll like. So, to give you the best possible experience in
              using Commit, we collect information from your interactions with
              our Services. Some of this information, you actively tell us (such
              as your email address, which we use to track your account or
              communicate with you). Other information, we collect based on
              actions you take while using Medium, such as what pages you view
              (including how much of a given page and for how long) and your use
              of product features (like Save to Bookmarks, posts, follows,
              comments and like). This information includes records of those
              interactions, your Internet Protocol address, information about
              your device (such as device or browser type), and referral
              information (how you got to a particular page).
              <br />
              <br />
              <br />
              ...
              <br />
              3. Generate aggregate, non-identifying information about how
            ...
            <p className="lg:w-2/3 mx-auto  leading-relaxed text-base text-left text-[#333333] pt-5">
              ...
              logs. By using the Services, you authorize Commit to transfer,
              store, and use your information in the Indonesia.
            </p>
            ...
            <p className="lg:w-2/3 mx-auto  leading-relaxed text-base text-left text-[#333333] pt-5">
              ...
              Settings page. When you interact with an email sent from Commit
              ...
              at legal@commit.com so we can investigate.
            </p>
          </div>
        </div>
      </div>
