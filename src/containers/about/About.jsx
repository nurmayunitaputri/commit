      ...
      <div className="bg-white text-[#00229B] body-font overflow-hidden">
        <div className="container px-5 pt-12 mx-auto">
          <div className="flex flex-col text-center w-full mx-auto mb-2">
            ...
            <p className="lg:w-2/3 text-5xl font-bold mx-auto text-left leading-relaxed text-[#00229B] pt-10 pb-7">About Commit</p>
          </div>
          ...
          <div className="flex flex-col w-full justify-center bg-blue">
            ...
            <div className="flex flex-col w-full justify-center bg-blue">
              <div className="lg:w-2/3 text-2xl rounded-lg bg-[#E2EFFF] pb-8  mx-auto text-left leading-relaxed mb-10">
                ...
                <p className="px-10 mx-auto font-base leading-relaxed text-lg text-left text-[#333333] pt-5">
                  SYNRGY Academy has a Main Bootcamp class, where this class facilitates people who want to increase their skills in the IT field. In this Main Bootcamp, a Final Project is held in groups. In this Final Project, we, Team D created this <span className="text-[#00229B] font-bold">Commit</span>  application and website.
                </p>
              </div>
            </div>
