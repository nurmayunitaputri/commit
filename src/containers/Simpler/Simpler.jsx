            ...
            <div className="flex flex-col w-full justify-center ">
              <div className="w-5/6 self-center">
                ...
                <p className="lg:w-2/3 pt-16 pb-3 text-center mx-auto leading-relaxed text-2xl text-[#00229B]">
                  You can only purchase Simpler on our Mobile App <span className="font-bold">Download Now !</span>
                </p>
                <div className="flex justify-center">
                  <button class="bg-[#00229B] inline-flex py-3 px-5 mb-16 rounded-lg items-center focus:outline-none">
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_2193_13321)">
                        <path
                          ...
                          fill="#FFD900"
                        />
                        <path d="M20.1404 17.4985L1.57715 34.9784C2.01287 35.0323 2.50479 34.9244 3.08475 34.6265C4.30236 34.0038 17.2103 27.4178 25.9704 22.9198L20.1404 17.4985Z" fill="#F43249" />
                        <path d="M20.1409 17.4985L25.9709 12.0246C25.9709 12.0246 4.39094 1.02114 3.08527 0.371601C2.59336 0.0993928 2.04211 0.0185352 1.54883 0.0993928L20.1409 17.4985Z" fill="#00EE76" />
                        <path d="M20.1406 17.4985L1.54846 0.0994263C0.793906 0.262419 0.15625 0.885266 0.15625 2.15906V32.9188C0.15625 34.0847 0.649668 34.9244 1.5773 35.0054L20.1406 17.4985Z" fill="#00D3FF" />
                      </g>
                      <defs>
                        <clipPath id="clip0_2193_13321">
                          <rect width="35" height="35" fill="white" transform="translate(0.15625 0.069519)" />
                        </clipPath>
                      </defs>
                    </svg>
