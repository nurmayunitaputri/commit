      ...
      <div className="bg-blue-200 text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-2">
            <h1 className="sm:text-4xl text-3xl font-medium title-font mb-2 mt-8 text-gray-900">
              Welcome to Simpler !{" "}
            </h1>
            <div className=" pt-[50px] px-2 pb-6 w-8/12 max-w-fit mx-auto">
              <Image src="Group 383.png" layout="fill" />
            </div>
            ...
            <div className="p-4 xl:w-1/4 md:w-1/2 w-full drop-shadow-2xl">
              <div className="h-full p-6 rounded-[34px] border-2 bg-white border-gray-300 flex flex-col relative overflow-hidden">
                <div className=" flex justify-end mb-3">
                  <div className="w-3/6 inline-block text-sm px-6 py-2 font-bold leading-none border rounded-full text-[#00229B] border-[#00229B] bg-[#00229B] text-center mt-4 lg:mt-0">
                    Regular
                  </div>
                </div>
