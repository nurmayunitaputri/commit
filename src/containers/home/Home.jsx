    ...
    <NoAuthProvider>
      <div className="bg-blue-200">
          ...
          <div className="container mx-auto py-3 px-3 lg:px-0">
            <div className="flex justify-between items-start">
              ...
              <div className="w-full block lg:flex ml-auto items-center ">
                <div className="input-group responsive mr-20 text-black text-sm xl:w-80 flex items-center pt-2 ml-10">
                  <input
                    type="search"
                ...
                <div className="text-sm flex items-center pt-2 ">
                  <a href="#responsive-header" className="block mt-4 lg:inline-block lg:mt-0 focus:text-blue-700 focus:outline-none text-gray-400 mr-11 ">
                ...
                <div className="dropdown-toggle hidden-arrow pt-2 mr-2 " href="#" id="dropdownMenuButton2" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  {' '}
                  hallo, Angga
                </div>
          ...
          <div className="flex flex-col justify-between items-stretch py-2 rounded-lg">
            <form className="py-2 rounded-tr-lg rounded-tl-lg bg-white">
              ...
              <div className="flex justify-center text-sm">
                <p className="px-[2%] py-[2%] text-[10px] rounded  bg-[#708beb] text-white">UI/UX</p>
                <p className="text-gray-400 pl-3 px-[5px] py-[5px]"> DKI Jakarta </p>
              </div>
              <div className="text-center text-[14px] text-black py-[8px]">Follow Your Dream!</div>
              <div className="flex justify-center border-t-4 pt-2">
                <div className="text-black text-center px-5 rounded-lg">
                  Followers
                  <p className="text-black text-center">3543</p>
                </div>
                <div className="text-black text-center px-5">
                  Following
                  <p className="text-black text-center">321</p>
                </div>
              </div>
            </form>
          </div>
        ...
        <div className="fixed rounded-lg right-0 h-max w-[20%] mr-[3.2rem] border-transparent text-center invisible lg:visible pt-[90px]">
          <div className="flex flex-col rounded-lg justify-between">
            <form className="w-full mx-auto bg-white pb-[10px] rounded-lg items-center">
              <p className="text-[14px] font-bold text-[#333333] pt-[20px] flex justify-start ml-[20px]">People you may follow</p>
              <div className="flex items-start ml-3 pt-3 text-sm ">
                <button className="block h-10 w-10 rounded-full overflow-hidden border-2 border-gray-600 focus:outline-none focus:border-white">
                  <img className="h-full w-full object-cover" src="cewek.jpg" alt="avatar"></img>
                </button>
                <p className="ml-[5px] text-[12px] font-bold pr-[3px]">Jen Conor</p>
                ...
                <button className="block overflow-hidden px-[3%] py-[2%] text-[12px] rounded-lg ml-[33px] bg-[#a8b8f1] text-white focus:outline-none focus:bg-blue-600 ">Follow</button>
              </div>
              ...
              <div className="flex items-start ml-3 pt-2 text-sm ">
                ...
                <p className="ml-[5px] text-[12px] font-bold pr-[3px]">Keylie Smith</p>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-600" viewBox="0 0 20 20" fill="currentColor">
                  <path
                    fill-rule="evenodd"
                    d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                ...
                <button className="block overflow-hidden px-[3%] py-[2%] text-[12px] rounded-lg ml-5 bg-[#a8b8f1] text-white focus:outline-none focus:bg-blue-600">Follow</button>
              </div>
              <div className="flex items-start ml-3 pt-2 text-sm ">
                <button className="block h-10 w-10 rounded-full overflow-hidden border-2 border-gray-600 focus:outline-none focus:border-white">
                  <img className="h-full w-full object-cover" src="cowo.jpg" alt="avatar"></img>
                </button>
                <p className="ml-[5px] text-[12px] font-bold pr-[3px]">Lebron James</p>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-600" viewBox="0 0 20 20" fill="currentColor">
                  <path
                    fill-rule="evenodd"
                    d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                ...
                <button className="block overflow-hidden px-[3%] py-[2%] text-[12px] rounded-lg ml-[10px] bg-[#a8b8f1] text-white focus:outline-none focus:bg-blue-600">Follow</button>
              </div>
            </form>
          </div>
                ...
                <div className="flex flex-cols gap-[10%] bg-white items-start pt-[15%] rounded-lg ">
                  <a href="#" className="block focus:text-blue-700 text-[#a8b8f1] focus:outline-none ml-[15px]">
                    <div className="flex items-start text-sm">
                      ...
                      <p className="ml-[5px] text-[12px] pt-[10px] font-semibold text-[#a8b8f1]">Media</p>
                    </div>
                  </a>
                  <a href="#" className="block focus:text-blue-700 text-[#a8b8f1] focus:outline-none ml-[15px]">
                    <div className="flex items-start text-sm">
                      ...
                      <p className="ml-[5px] text-[12px] pt-[10px] font-semibold text-[#a8b8f1]">Public Post</p>
                    </div>
                  </a>
                  <button className="block overflow-hidden h-[35px] w-[50px] text-[12px] rounded-lg ml-[220px] bg-[#a8b8f1] text-white focus:outline-none focus:bg-blue-700">Post</button>
                </div>
              </form>
            </div>
          </div>
            ...
            <div className="min-h-[15rem] text-white rounded-lg p-2">
              <form className="py-2 rounded-lg bg-white pl-2">
                ...
                <div className="flex flex-cols gap-2 bg-white items-start pt-5 rounded-lg text-gray-700 text-[12px] ml-2 ">
                  ...
                  <br />
                  User Experience [UI] is the process of designing a product trought a user approach . With this approach, you can create a product that fits the needs and desires of users.
                  <br />A product with a good UX design will create a pleasant experience for user when using your product. Users become easy and comfortable when using the product
                </div>
                <p className="text-gray-400 text-[12px] ml-2 pt-5">See more ...</p>
                <div className="flex flex-cols gap-[5%] bg-white items-start pt-[5%] rounded-lg ">
                  <a href="#" className="block focus:text-blue-700 text-gray-500 focus:outline-none ml-[10px]">
                    <div className="flex items-start text-sm">
                      ...
                      <p className="ml-[5px] text-[12px] pt-[8px] font-semibold text-gray-500">88</p>
                    </div>
                  </a>
                  <a href="#" className="block focus:text-blue-700 text-gray-500 focus:outline-none ml-[2px]">
                    <div className="flex items-start text-sm">
                      ...
                      <p className="ml-[5px] text-[12px] pt-[8px] font-semibold text-gray-500">12</p>
                    </div>
                  </a>
          ...
          <div className="border-transparent  rounded-lg ">
            <div className="min-h-[15rem] text-white rounded-lg p-2">
              <form className="py-2 rounded-lg bg-white pl-2">
                ...
                <div className="flex flex-cols gap-2 bg-white items-start pt-5 rounded-lg text-gray-700 text-[12px] ml-2 ">
                  [Front-End Developer]
                  <br />A front-end developer is required to be able to master programming languages such as HTML, CSS, and JavaScript in order to produce a good, attractive, and interactive wb layout that allows visitors to have an
                  interesting. experience when visiting the website, starting from design, selection. font, colors, dropdown menus, to sliders and other components that stimulate interaction with site visitors.
                </div>
                <p className="text-gray-400 text-[12px] ml-2 pt-5">See more ...</p>
                ...
                <div className="flex flex-cols gap-[5%] bg-white items-start pt-[5%] rounded-lg ">
                  <a href="#" className="block focus:text-blue-700 text-gray-500 focus:outline-none ml-[10px]">
                    <div className="flex items-start text-sm">
                      ...
                      <p className="ml-[5px] text-[12px] pt-[8px] font-semibold text-gray-500">2</p>
                    </div>
                  </a>
                  <a href="#" className="block focus:text-blue-700 text-gray-500 focus:outline-none ml-[2px]">
                    <div className="flex items-start text-sm">
                      ...
                      <p className="ml-[5px] text-[12px] pt-[8px] font-semibold text-gray-500">5</p>
                    </div>
                  </a>
          ...
          <div className="border-transparent  rounded-lg ">
            <div className="min-h-[15rem] text-white rounded-lg p-2">
              <form className="py-2 rounded-lg bg-white pl-2">
                ...
                <div className="flex flex-cols gap-2 bg-white items-start pt-5 rounded-lg text-gray-700 text-[12px] ml-2 ">[Develop Android UI By Jen Conor]</div>
                <p className="text-gray-400 text-[12px] ml-2 pt-5">See more ...</p>
                <div className="block h-[50%] w-[90%] ml-7 pt-5">
                ...
                <div className="flex flex-cols gap-[5%] bg-white items-start pt-[5%] rounded-lg ">
                  <a href="#" className="block focus:text-blue-700 text-gray-500 focus:outline-none ml-[10px]">
                    <div className="flex items-start text-sm">
                      ...
                      <p className="ml-[5px] text-[12px] pt-[8px] font-semibold text-gray-500">121</p>
                    </div>
                  </a>
                  <a href="#" className="block focus:text-blue-700 text-gray-500 focus:outline-none ml-[2px]">
                    <div className="flex items-start text-sm">
                      ...
                      <p className="ml-[5px] text-[12px] pt-[8px] font-semibold text-gray-500">100</p>
                    </div>
                  </a>
                  <a href="#" className="block focus:text-blue-700 text-gray-500 focus:outline-none ml-[63%]">
                    <div className="flex items-start text-sm">
