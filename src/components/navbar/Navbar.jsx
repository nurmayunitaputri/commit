        ...
        <div className="flex justify-between items-start">
          ...
          <div className="w-full block lg:flex ml-auto items-center ">
            ...
            <div className="text-sm flex items-center pt-2 pl-10">
              <Link href="/home">
                <div href="/home" className="block mt-4 lg:inline-block lg:mt-0 focus:text-blue-700 focus:outline-none text-gray-400 mr-11 ">
              ...
              <Link href="/simpler">
                <div href="/simpler" className="block mt-4 lg:inline-block lg:mt-0 focus:text-blue-700 focus:outline-none text-gray-400 mr-11 ">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path
            ...
            <div className="relative pl-3">
              <button className="block h-10 w-10 rounded-full overflow-hidden border-2 focus:outline-none ">
